...
export type LocacaoInsert = Database["public"]["Tables"]["locacoes"]["Insert"];

export type ItemLocacao = Database["public"]["Tables"]["itens_locacao"]["Row"];
export type ItemLocacaoInsert = Database["public"]["Tables"]["itens_locacao"]["Insert"];
